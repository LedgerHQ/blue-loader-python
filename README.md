...
Any updated `tests/fixtures/ref_*.apdu` file(s) should then be committed alongside the code change so the diff in the reference file documents exactly what changed at the wire level.
