...
_PARAMETER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="bluehsmserver.Parameter.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="alias",
            full_name="bluehsmserver.Parameter.alias",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="local",
            full_name="bluehsmserver.Parameter.local",
            index=2,
            number=3,
            type=8,
            cpp_type=7,
...
_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="bluehsmserver.Request.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="parameters",
            full_name="bluehsmserver.Request.parameters",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="reference",
            full_name="bluehsmserver.Request.reference",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="elf",
            full_name="bluehsmserver.Request.elf",
            index=3,
            number=4,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="close",
            full_name="bluehsmserver.Request.close",
            index=4,
            number=5,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="largeStack",
            full_name="bluehsmserver.Request.largeStack",
            index=5,
            number=6,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="bluehsmserver.Request.remote_parameters",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
...
_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="bluehsmserver.Response.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="response",
            full_name="bluehsmserver.Response.response",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="message",
            full_name="bluehsmserver.Response.message",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="exception",
            full_name="bluehsmserver.Response.exception",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
