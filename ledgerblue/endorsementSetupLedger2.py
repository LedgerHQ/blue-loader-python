...
def get_argparser():
	...
	parser.add_argument("--url", help="Websocket URL", default="wss://scriptrunner.api.live.ledger.com/update/endorse")
...
if __name__ == '__main__':
	...
	queryParameters['endorse'] = args.endorsement
	queryParameters['endorseScheme'] = args.key
