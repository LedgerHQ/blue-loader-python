...
if __name__ == '__main__':
    ...
    if args.perso is None:
        raise Exception("No personalization specified")
    if args.endorsement is None:
    ...
    certificate = bytearray([len(remotePublicKey)]) + remotePublicKey + bytearray(
        [len(remotePublicKeySignature)]) + remotePublicKeySignature
