...
def getDeployedSecretV2(dongle, masterPrivate, targetId, issuerKey):
    ...
    if targetId & 0xF == 0x2:
        ...
        ret = {'ecdh_secret': secret, 'devicePublicKey': devicePublicKey}
    return ret
...
if __name__ == '__main__':
    ...
    if args.issuerKey is None:
        args.issuerKey = "0490f5c9d15a0134bb019d2afd0bf297149738459706e7ac5be4abc350a1f8180" \
                         "57224fce12ec9a65de18ec34d6e8c24db927835ea1692b14c32e9836a75dad609"
