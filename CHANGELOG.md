...
- A regression impacting Nano S applications installation when commit command was missed

## [0.1.57] - 2026-06-11

### Changed

- Update appHash module to compute the proper application's hash
- loadApp now use appHash to compute hash
